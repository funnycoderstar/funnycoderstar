...
> `activated`和`deactivated`这两个生命周期函数涉及到`<keep-alive>`这个组件,所以想了解这个生命周期函数的可以看一下我的[另一篇文章](http://wangyaxing.cn/2017/09/06/vue%E7%BB%84%E4%BB%B6%E4%B9%8Bkeep-alive/#more)
