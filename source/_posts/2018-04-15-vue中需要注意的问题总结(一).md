...
#### 简单的解释一下原理: 
vue在创建实例的时候把data深度遍历所有属性,并使用 [Object.defineProperty](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/defineProperty) 把这些属性全部转为 getter/setter。让 Vue 追踪依赖，在属性被访问和修改时通知变化。所以属性必须在 data 对象上存在才能让 Vue 转换它，这样才能让它是响应的。
...
![title](http://upload-images.jianshu.io/upload_images/3297464-26187203e60ab47a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
```
打开命令行在命令行中输入vm.a = 'change';查看效果
```
![title](http://upload-images.jianshu.io/upload_images/3297464-c5b8f6981f7410f7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
- 打开页面,会出现下面这样
![1](http://upload-images.jianshu.io/upload_images/3297464-107dff63973203d6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

用setTimeout模拟请求后端接口的场景

- 点击`title2`,出现下面的情况
![2](http://upload-images.jianshu.io/upload_images/3297464-7e1366c72e18c5bc.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
- 再次点击`title1`,出现下面的情况,你会发现从后端请求的数据会快速显示出来,但是如果你此时不用
![3](http://upload-images.jianshu.io/upload_images/3297464-910cec4293e6e2b2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
上述这些问题从[vue官方文档](https://vuejs.org/)中均能找到答案,当然想要更深入的理解为什么,还需要从[vue源码分析](https://github.com/vuejs/vue)入手;
