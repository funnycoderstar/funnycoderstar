...
> 原理: 宽高都不设置(即为 0),只设置边框,如果 4 个边框都设置宽度(border-width),样式(border-style)和颜色(border-color)
...
效果如图
![](https://cdn.ionestar.cn/border.jpg)
...
![](https://cdn.ionestar.cn/border-arrow.jpg)

### 3,css 实现 toolTip(空心三角箭头)源码如下
...
![title](https://cdn.ionestar.cn/border1.jpg)
